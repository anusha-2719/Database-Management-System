...
INSERT INTO `emp` VALUES (1,'Alice','Kumar','R&D',80000,'2020-03-15'),(2,'Bob','Sharma-Old','Sales',60000,'2019-08-01'),(3,'Carol','Kumar','R&D',85000,'2021-02-10'),(4,'Dave','Patel','Marketing',55000,'2018-11-20'),(5,'Eve','Sharma','Sales',62000,'2022-01-05'),(6,'Frank','Kumar','R&D',78000,'2024-07-01');
...
INSERT INTO `employee` VALUES (1001,'Alice','F','2001-03-15',1);
...
INSERT INTO `employees` VALUES (1,'anusha',456),(2,'akshara',789),(1,'anusha',10),(2,'Bob',20),(1,'anusha',456),(2,'akshara',789);
...
INSERT INTO `sales` VALUES (1,'Laptop','Electronics',3,800.00),(2,'Smartphone','Electronics',5,600.00),(3,'Desk','Furniture',2,150.00),(4,'Chair','Furniture',4,100.00),(5,'Mouse','Electronics',10,20.00);
...
CREATE TABLE `students` (
  ...
  `os` int DEFAULT NULL,
  UNIQUE KEY `sno` (`sno`),
  CONSTRAINT `students_chk_1` CHECK ((`age` <= 21))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `students` VALUES (1,'jaanu',20,95,96),(2,'deepu',19,98,91),(3,'sindu',18,60,84);
...
CREATE TABLE `students1` (
  `sno` int DEFAULT NULL,
  `name` varchar(30) DEFAULT 'anusha',
  `age` int DEFAULT NULL,
  `dbms` int DEFAULT NULL,
  `os` int DEFAULT NULL,
  UNIQUE KEY `sno` (`sno`),
  CONSTRAINT `students1_chk_1` CHECK ((`age` <= 21))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `students1` VALUES (1,'jaanu',20,95,96),(2,'deepu',19,98,91),(3,'sindu',18,60,84);
...
INSERT INTO `tcl` VALUES (64,'PRIYANTH',100000),(64,'PRIYANTH',1222),(64,'PRIYANTH',23444);
...
-- Dump completed on 2025-10-21 14:20:10
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
...
LOCK TABLES `tcl` WRITE;
/*!40000 ALTER TABLE `tcl` DISABLE KEYS */;
INSERT INTO `tcl` VALUES (64,'PRIYANTH',100000),(64,'PRIYANTH',1222),(64,'PRIYANTH',23444),(64,'PRIYANTH',1222),(64,'PRIYANTH',23444),(64,'PRIYANTH',0);
/*!40000 ALTER TABLE `tcl` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2025-10-21 14:20:11
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
...
INSERT INTO `counter` VALUES (10,'HR'),(20,'IT'),(40,'Finance');
...
LOCK TABLES `employees` WRITE;
/*!40000 ALTER TABLE `employees` DISABLE KEYS */;
INSERT INTO `employees` VALUES (1,'Alice','Johnson','HR',60637.50),(2,'Bob','Smith','Finance',65000.00),(4,'David','Brown','IT',72000.00),(5,'Eve','Davis','Marketing',58000.00),(6,'Frank','Wilson','Finance',67000.00),(7,'Grace','Clark','HR',58432.50),(8,'Hank','Adams','IT',75000.00),(9,'Ivy','Miller','Marketing',60000.00),(10,'Jack','Taylor','HR',59535.00),(11,'Karen','White','Sales',61000.00);
/*!40000 ALTER TABLE `employees` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `people` WRITE;
/*!40000 ALTER TABLE `people` DISABLE KEYS */;
INSERT INTO `people` VALUES (1,'Alice',10),(2,'Bob',20),(3,'Charlie',30);
/*!40000 ALTER TABLE `people` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-10-21 14:20:12
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-07-08 05:17:51',NULL),('diagnostics.include_raw','OFF','2025-07-08 05:17:51',NULL),('ps_thread_trx_info.max_length','65535','2025-07-08 05:17:51',NULL),('statement_performance_analyzer.limit','100','2025-07-08 05:17:51',NULL),('statement_performance_analyzer.view',NULL,'2025-07-08 05:17:51',NULL),('statement_truncate_len','64','2025-07-08 05:17:51',NULL);
...
-- Dump completed on 2025-10-21 14:20:16
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
-- Host: localhost    Database: anusha
-- ------------------------------------------------------
-- Server version	8.0.42
...
INSERT INTO `company_data` VALUES ('wipro',5000),('ibm',8000),('dell',9000),('wipro',2000),('dell',10000);
...
LOCK TABLES `students` WRITE;
/*!40000 ALTER TABLE `students` DISABLE KEYS */;
INSERT INTO `students` VALUES (1,'anusha',90),(2,'ramya',95),(1,'anusha',90),(2,'ramya',95);
/*!40000 ALTER TABLE `students` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2025-10-21 14:20:17
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
...
LOCK TABLES `company` WRITE;
/*!40000 ALTER TABLE `company` DISABLE KEYS */;
INSERT INTO `company` VALUES ('wipro',5000),('ibm',8000),('dell',9000),('wipro',2000),('dell',1000),('wipro',5000),('ibm',8000),('dell',9000),('wipro',2000),('dell',10000);
/*!40000 ALTER TABLE `company` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
LOCK TABLES `employee` WRITE;
/*!40000 ALTER TABLE `employee` DISABLE KEYS */;
INSERT INTO `employee` VALUES ('wipro',5000),('ibm',8000),('dell',9000),('wipro',2000),('dell',10000);
/*!40000 ALTER TABLE `employee` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `employees` WRITE;
/*!40000 ALTER TABLE `employees` DISABLE KEYS */;
INSERT INTO `employees` VALUES (1,'bhanu',456),(2,'akshara',789),(3,'akshitha',123);
/*!40000 ALTER TABLE `employees` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
